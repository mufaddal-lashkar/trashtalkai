...
export default function ChatBot() {
    ...
    const sampleInput = `Mummy ne kal mujhe 5 baar call kiya tha, maine sirf ek baar uthaya, aur ghar late aaya. Par maine unke liye rajma chawal bhi banaya. Kitna pyaar karti hain mujhse?`
    return (
        <div className="bg-[#f2f2f2] text-[#333333] min-h-screen w-full pt-40 m-0">
            <h1 className="text-4xl font-bold mb-6 text-center">Maa Ka Pyaar Meter</h1>
