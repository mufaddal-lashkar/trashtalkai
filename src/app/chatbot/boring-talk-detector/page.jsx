...
export default function ChatBot() {
    ...
    const sampleInput = `Bhai, kal Sharma ji mujhe apne 3-hour-long Thailand trip ke details suna rahe the. Kitna paka rahe the?`
    return (
        <div className="bg-[#f2f2f2] text-[#333333] min-h-screen w-full pt-40 m-0">
            <h1 className="text-4xl font-bold mb-6 text-center">Kitna Paka Raha Hai? - Boring Talk Detector</h1>
