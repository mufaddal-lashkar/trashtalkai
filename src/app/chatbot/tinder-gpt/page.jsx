...
export default function ChatBot() {
    ...
    const sampleInput = `Bhai, mujhe ek aisi pickup line chahiye jo ek gamer ladki ke liye ho. Aisi line jo dil jeet le, ya kam se kam block na kare!`

    return (
        <div className="bg-[#f2f2f2] text-[#333333] min-h-screen w-full pt-40 m-0">
            <h1 className="text-4xl font-bold mb-6 text-center">Tinder GPT - Pickup Line Generator</h1>
