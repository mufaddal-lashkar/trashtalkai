...
export default function ChatBot() {
    ...
    const sampleInput = `Babu Bhaiya, mere paas ₹50,000 hain. Crypto me daal du ya Mutual Funds me? Risk lene ka mood hai, lekin paisa doob gaya toh ghar wale maarenge.`

    return (
        <div className="bg-[#f2f2f2] text-[#333333] min-h-screen w-full pt-40 m-0">
            <h1 className="text-4xl font-bold mb-6 text-center">Babu Bhaiya - The Investment Advisor</h1>
